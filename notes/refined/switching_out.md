## Switching out
One way of dealing with problematic game states is to switch out our metronome user, and perhaps switch them back in. This could save our ability to identify a path, but also introduces many other variables.
...
TOCONFIRM: Speed tie + Lagging Tail + Fling = ??
